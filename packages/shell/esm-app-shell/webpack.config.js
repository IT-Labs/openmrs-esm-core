...
const openmrsPageTitle = process.env.OMRS_PAGE_TITLE || 'WellCare360';
const openmrsFavicon = process.env.OMRS_FAVICON || 'https://wellcare360-resources.s3.eu-north-1.amazonaws.com/favicon.ico';
